...
def transform(df, csv_path):
    ...
    df['MC_GBP_Billion'] = round(df['Total assets (2022) (US$ billion)'] * exchange_rate['GBP'], 2)
    df['MC_EUR_Billion'] = round(df['Total assets (2022) (US$ billion)'] * exchange_rate['EUR'], 2)
    df['MC_INR_Billion'] = round(df['Total assets (2022) (US$ billion)'] * exchange_rate['INR'], 2)
...
if __name__ == '__main__':
    ...
    df = ic(extract(url, 'By total assets'))
